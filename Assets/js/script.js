...
function getData(city) {
    let URL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=metric" + apiKey
...
function getUvData(latitude, longtitude) {
    let URL = "https://api.openweathermap.org/data/2.5/onecall" + apiKey + "&lat=" + latitude + "&lon=" + longtitude 
...
function getForecastData(cityName) {
    ...
    return $.ajax({
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + "Sydney" + "&appid=45bb91d664f0e678d9a99e88e2efe20e",
        method: "GET",
        dataType: "jsonp",
        success: function (response) {
